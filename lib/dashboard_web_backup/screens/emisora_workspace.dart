...
class _EmisoraWorkspaceState extends State<EmisoraWorkspace> {
  ...
  Widget build(BuildContext context) {
    ...
    final showLogo = (_logoUrl.text.trim().startsWith('http'));
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(Icons.radio, size: 40, color: scheme.primary),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Información visible de la estación (nombre, logo y color).',
                      ...
                      BrandImageUploadZone(
                        ...
                        uploadButtonLabel: 'Subir Logo de Estación',
                      ...
                      Text(
                        'Este color se usa para resaltar la estación en la app.',
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(color: scheme.onSurfaceVariant),
                      ),
                      const SizedBox(height: 12),
                      Row(
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Este color se usa para combinar con el color primario.',
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(color: scheme.onSurfaceVariant),
                      ),
                      const SizedBox(height: 12),
                      Row(
